...
export default class CameraModal extends React.PureComponent {
  ...
  sendMessageCapturedImage = () => {
    console.log("inside sendmessageCapturedImage");
      ...
      <Modal>
        <div className="modal">
          ...
          <div class="cameraCaptureModalContent">
            <video id="vCameraCapture" autoPlay height="100%" width="100%" />
          ...
          <div className="cameraCaptureModalFooter">
            ...
            <div
              id="btnCapturedImageSend"
              className="btn cameraSendButton"
              onClick={this.sendMessageCapturedImage.bind(this)}
              style={{ display: "none" }}
            >
              Share
            </div>

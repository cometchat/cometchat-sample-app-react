...
class CallIncomingNotification extends React.PureComponent {
  ...
  render() {
    const user_avatar = utils.CheckEmpty(this.props.user_avatar)
      ...
      <Modal>
        <div className="callNotificationModal">
          <div class="CallNotificationHeader">
            ...
            <div
              class="btnAcceptCallNotification"
              dangerouslySetInnerHTML={{ __html: icon_call_accept }}
              onClick={this.acceptCall.bind(this)}
            />

            <div
              class="btnRejectCallNotification"

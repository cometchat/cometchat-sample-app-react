...
class CallModal extends React.PureComponent {
  ...
  componentDidMount() {
    console.log(
      "Inside componentDidMount call status: " + this.props.call.callStatus
    );

    if (this.props.call.callStatus == 1) {
    } else {
      var callType = "";
      if (this.props.call_type == "audio") callType = CometChat.CALL_TYPE.AUDIO;
      else {
        callType = CometChat.CALL_TYPE.VIDEO;
      }

      this.props.initCall(
        this.props.call.callInitData.call_user_id,
        callType,
        this.props.call.callInitData.call_user
      );
    }
  }
  ...
  render() {
    if (this.props.call.callStatus == 1) {
      ...
      return <CCCall callData={this.props.call.callData} />;
    } else {
      //init call ui
      return (
        <Modal>
          <div className="modal">
            <div class="CallModalContent">
              <div className="callUserImage">
                <img
                  src={this.props.call.callInitData.user_avatar}
                  class="callUserImageObj"
                />
              </div>
            ...
            <div class="callModalFooter">
              ...
              <div
                class="btnRejectCall"
                dangerouslySetInnerHTML={{ __html: icon_call_reject }}
...
const mapDispachToProps = dispatch => {
  return {
    initCall: (uid, callType, userType) =>
      dispatch(actionCreator.initializeCall(uid, callType, userType)),

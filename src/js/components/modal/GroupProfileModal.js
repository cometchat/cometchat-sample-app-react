...
class GroupProfileModal extends React.PureComponent {
    ...
    render(){
        ...
        const deleteGroup = groupLoggedinUser == undefined?null : (groupLoggedinUser.scope=="admin" ? (<Row className="profileNameRow" ><Col className="groupProfileLeaveGroupText" lg={10} xs={8} >Delete Group</Col><Col className="groupProfileLeaveButton" lg={1} xs={2}  onClick = {this.props.close} dangerouslySetInnerHTML={{ __html: icon_delete_group }}></Col></Row>):null);
        return ( 
            <Modal>

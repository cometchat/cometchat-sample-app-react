      ...
      <Row className="logincontainer border-radius-top">
        <Col md={4} class="login-form-container">
          ...
          <div className="loginSampleContainer">
            ...
            <div
              className="loginSampleUser"
              onClick={this.handleUserListItemClick.bind(this, "superhero1")}
            >
            ...
            <div
              className="loginSampleUser"
              onClick={this.handleUserListItemClick.bind(this, "superhero2")}
            >
              <img
                className="loginSampleAvatar"
                src={captainAmerica}
                width={32}
              />
              <div className="loginSampleUserNameContainer">
            ...
            <div
              className="loginSampleUser"
              onClick={this.handleUserListItemClick.bind(this, "superhero3")}
            >
            ...
            <div
              className="loginSampleUser"
              onClick={this.handleUserListItemClick.bind(this, "superhero4")}
            >

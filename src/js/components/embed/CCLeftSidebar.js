  ...
  render() {
    return (
      <div className="ccMainContainer">
        ...
        <Tab.Container
          id="sidebarTabContainer"
          defaultActiveKey={this.state.activeTab}
        >
          <Row className="clearfix">
            <div
              key="sidebarScrollContainer"
              ref={this.sidebarScrollContainer}
              className="cc-no-padding border border-radius-top bg-white color-border "
              style={ccUserStyle}
            >
            ...
            <Col sm={12} className="cc-no-padding bg-white bottomNav">
              ...
              >
                ...
                <NavItem eventKey="contacts">
                  <span
                    dangerouslySetInnerHTML={{ __html: tab_icon_contact }}
                    className="tab-icon"
                    height="20px"
                    width="20px"
                  />
                ...
                <NavItem eventKey="groups">
                  <span
                    dangerouslySetInnerHTML={{ __html: tab_icon_group }}
                    className="tab-icon"
                    height="20px"
                    width="20px"
                  />

            ...
            <Row className="ccMessageHeader">
                ...
                <Col lg={7} className="cc-no-padding h-100" onClick={this.showModal.bind(this)} style={{cursor:"pointer"}}>
                    <span className="messageHeaderAvatar">
                        <img className="userAvatar img-circle" src={profileData.avatar} height="42px" width="42px" />
                    </span>
                ...
                <Col lg={5} className="cc-no-padding h-100">
                    <div className="ccMessageHeaderMenu">
                        <span className="ccmessageHeaderIcon " dangerouslySetInnerHTML={{__html:icon_audio}} onClick={this.initiateCall.bind(this,'audio',profileData.name,profileData.avatar)}/>
                        <span className="ccmessageHeaderIcon " dangerouslySetInnerHTML={{__html:icon_video}} onClick={this.initiateCall.bind(this,'video',profileData.name,profileData.avatar)}/>
                        {showMore}
                    </div>
                </Col>                
            </Row>
